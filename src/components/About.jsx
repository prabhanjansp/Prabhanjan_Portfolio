        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 xl:gap-20">
            ...
            >
              ...
              >
                <h1
                  className={`text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl font-bold leading-tight tracking-tight ${darkMode ? "text-white" : "text-gray-900"
                    }`}
                >
                  <span
                  ...
                  <span
                    className={`block mt-1 ${darkMode ? "text-gray-200" : "text-gray-800"
                      }`}
                  >
                    Puranik
                  </span>
              ...
              >
                <p
                  className={`text-xl sm:text-2xl md:text-3xl lg:text-2xl xl:text-3xl font-bold leading-relaxed ${darkMode ? "text-emerald-300" : "text-amber-700"
                    }`}
                >
                  {aboutData.tagline}
                </p>
              ...
              >
                <p
                  className={`text-base sm:text-lg md:text-xl leading-relaxed ${darkMode ? "text-gray-300" : "text-gray-700"
                    }`}
                >
                  {aboutData.bio}
                </p>
              ...
              >
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                  <div className="text-center sm:text-left">
                    <h3
                      className={`text-lg sm:text-xl font-bold mb-1 ${darkMode ? "text-white" : "text-gray-900"
                        }`}
                    >
                      {`  Let's Collaborate!`}
                    </h3>
                    <p
                      className={`text-sm sm:text-base ${darkMode ? "text-teal-200" : "text-amber-700"
                        }`}
                    >
